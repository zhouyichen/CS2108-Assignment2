...
def main(_):
  ...
  run_inference_on_images(dp_train_raw_data, vc_train_raw_data, train_frame_folder)
  run_inference_on_images(dp_test_raw_data, vc_test_raw_data, test_frame_folder)
